...
- **Population generation**: Gaussian decay from randomly placed cities/towns. Three density tiers: urban (pop > 150, leans Blue ~62%), suburban (80–150, swing), rural (≤80, leans Red ~62%). Yellow is a third party (~10–15%).
